...
class MuZeroConfig:
    def __init__(self, args):
        ...
        # Evaluate
        self.muzero_player = args.beginning_turn  # Turn Muzero begins to play (0: MuZero plays first, 1: MuZero plays second)
        ...
        self.temperature_threshold = 6  # Number of moves before dropping temperature to 0 (ie playing according to
        # the max)
